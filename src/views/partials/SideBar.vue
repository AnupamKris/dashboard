...
<template>
  <aside
    v-if="isShowSideBar"
    class="scrollbox flex h-screen w-14 flex-col overflow-y-hidden border-r bg-background px-2 pb-2 pt-6 transition-all duration-300 hover:w-72 dark:bg-pri/5">
