...
<template>
  <div class="w-full">
    ...
    <section class="mx-auto w-full max-w-7xl">
      ...
      <CreatePersistentVolumeModal ref="createPersistentVolumeModalRef"
        :callback-on-create="refetchPersistentVolumes" />
      ...
      <ModalDialog :close-modal="closeRestoreNowModal" :is-open="isRestoreNowModalOpen" non-cancelable>
        ...
        <template v-slot:footer>
          <div class="flex w-full flex-col space-y-2">
            ...
            <FilledButton class="w-full" type="secondary" v-if="!isRestoreNowButtonLoading"
              :click="closeRestoreNowModal">
              Cancel
            </FilledButton>
          </div>
        </template>
      ...
      <Table class="mt-8">
        ...
        <template v-slot:body>
          <PersistentVolumeRow :delete-persistent-volume-with-confirmation="deletePersistentVolumeWithConfirmation"
